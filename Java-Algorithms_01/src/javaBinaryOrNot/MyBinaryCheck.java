package javaBinaryOrNot;

/* Write a program to check the given number is binary number or not
 * 
 * The binary numeral system or base-2 number system, represents numerical values using
 * two symbols: 0 and 1. More specifically, the usual base-2 system us a positional notation
 * with a radix of 2. Because of its straightforward implementation in digital electronic
