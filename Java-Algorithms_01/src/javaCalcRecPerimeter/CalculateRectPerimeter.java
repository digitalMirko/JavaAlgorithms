package javaCalcRecPerimeter;

// Calculate Rectangular Perimiter using Java
// This program calculates the perimeter of Rectangle using its length and width
...
public class CalculateRectPerimeter {
	...
	public static void main(String[] args) {
		...
		// Perimeter of a rectagle is 2 * (length + width);
...
/*
 * Output of Calculate Rectangle Perimeter using Java
