package javaFindLongestSubstringWO_RepeatingChars;

/* Find longest substring without repeating characters
 * 
 * Given a string, find the longest substrings without repeating characters. Iterate though
 * the given string, find the longest maximum substrings. 
 */
