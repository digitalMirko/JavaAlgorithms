 ...
 * This Java Interface example describes how interface is 
 * defined and being used is Java language.
 * 
 ...
 * To implement an interface use implements keywords
...
public class JavaInterfaceExample implements IntExample {
	...
	/*
	 * We have to define the method declare in implemented interface,
...
// OUTPUT of the above Java Interface example would be:
// Hello Visitor!
